...
"""
This script generate new email account, which you can use.
"""

# https://github.com/sameera-madushan/Mail-Swipe.git
...
def checkMails():
    ...
    if length == 0:
        ...
        final_directory = os.path.join(current_directory, r'../../scripts/All Mails')
        ...
        for i in idList:
            ...
            mail_file_path = os.path.join(final_directory, f'{"linked_in" if sender[-12:]=="linkedin.txt" else sender}.txt')
            # {sender}_{i}.txt
...
def which_email():
    """
    It should return name of account
    """
    return mail
